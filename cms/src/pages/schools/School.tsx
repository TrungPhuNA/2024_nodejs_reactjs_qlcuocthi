...
const packageData: Package[] = [
    {
        name: 'Trường THCS Bá Ngọc',
        username: 'phuphan',
        avatar: 'http://localhost:5173/src/images/user/user-01.png',
        email: 'phuphan@interspace.vn',
        price: 0.0,
    ...
    {
        name: 'Trường THCS phổ thông CVA',
        username: 'ducanh',
        avatar: 'http://localhost:5173/src/images/user/user-01.png',
        email: 'ducanh@interspace.vn',
        price: 59.0,
        invoiceDate: `Jan 13,2023`,
        status: 'Tạm ẩn',
        type: 'student'
...
const SchoolPage: React.FC = () => {
    ...
    return (
        <DefaultLayout>
            ...
            <FormCreateOrUpdateSchool open={open} setOpen={setOpen}/>
                            ...
                            {packageData.map((packageItem, key) => (
                                <tr key={key}>
                                    <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                        <div className={'flex'}>
                                            <img src={packageItem.avatar} alt=""
                                                 className={'w-15 h-15 border-100 mr-2'}/>
                                            <div>
